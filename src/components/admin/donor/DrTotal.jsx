  ...
  return (
    <div className="p-4 sm:ml-64">
      <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 flex flex-col gap-5">
        <h1 className="text-teal-400 text-xl text-center font-bold">Total Donor</h1>
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th   scope="row" className="px-6 py-4">Rakesh kumar</th>
                <td
                
                  className="px-6 py-4 font-medium  w4itespace-nowrap dark:text-white"
                >
                  rakeshkumar7474@gmail.com
                </td>
                <td className="px-6 py-4">9746468348</td>
