...
<div className="p-4 sm:ml-64">
      <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 flex flex-col gap-5">
        <h1 className="text-teal-400 text-xl text-center font-bold">Rejected Needer</h1>
            ...
            <tbody>
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-3 py-2">
                  <a
                    href="#"
                    className="font-medium py-2 px-3 rounded-md bg-red-400 text-white hover:underline"
                  >
                    Rejected 
                  </a>
                </td>
